...
function GameMode:InitGameMode()
	...
	self.hChampionList = LoadKeyValues("scripts/npc/npc_heroes_custom.txt")
	self.hAbilityList = LoadKeyValues("scripts/npc/npc_abilities_custom.txt")
	print('[DotL] Loaded custom champion data')
